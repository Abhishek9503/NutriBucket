...
const ForgotPassword = () => {
  ...
  return (
    <Layout title={'Forgot Password - NutriBucket'}>
      <div className='form-container'>
        <form onSubmit={handleSubmit}>
          ...
          <div className='mb-3'>
            <input type="text" value={answer} onChange={(e) => setAnswer(e.target.value)} className='form-control' id="exampleInputAnswer" placeholder="Enter Your Favourite Sports Name" required />
          </div>
          <div className='mb-3'>
